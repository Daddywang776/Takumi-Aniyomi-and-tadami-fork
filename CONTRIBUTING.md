...
Thanks for your interest in improving Takumi. Please read the following before
opening an issue or pull request.

## Scope and legal policy

Takumi is a **neutral media library manager and player**. To keep the project
...
- Any change that promotes Takumi as a way to access content **for free** or
  unlawfully, or that uses third-party trademarks, logos, or titles.

Takumi does not host, bundle, or endorse any content or sources. Please help us
keep it that way.
